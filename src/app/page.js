    ...
    <main className="container relative mx-auto scroll-my-12 overflow-auto p-4 print:p-12 md:p-16">
      ...
      <div className="flex-1 space-y-1.5">
          ...
          <p className="max-w-md text-pretty font-mono text-sm text-muted-foreground">
            Full Stack focused on building products with extra
            attention to detail
          </p>
        ...
        <Image className="aspect-square h-full w-full" width="120" height="120" alt="julioxdev" src="/julio.jpeg"/>
        </span>
      </div>
        ...
        <section className="flex min-h-0 flex-col gap-y-3">
          ...
          <p className="text-pretty font-mono text-sm text-muted-foreground">
            As a Full Stack, I have successfully taken multiple
            products from 0 to 1.  Currently, I work
            mostly with JavaScript, React, Node.js, and Nextjs. I have over 5
            years of experience in working remotely.
          </p>
        </section>
        <section className="flex min-h-0 flex-col gap-y-3">
          ...
          <div className="rounded-lg bg-card text-card-foreground">
            ...
            Currently developing digital marketing solutions at Coppel using TypeScript, JavaScript, React, and Next.js
            </div>
          </div>
          <div className="rounded-lg bg-card text-card-foreground">
            <div className="flex flex-col space-y-1.5">
            ...
            <div className="text-pretty font-mono text-muted-foreground mt-2 text-xs">
            I managed and designed web pages and systems using HTML, CSS, and JavaScript.
            </div>
          </div>
          <div className="rounded-lg bg-card text-card-foreground">
            <div className="flex flex-col space-y-1.5">
            ...
            <div className="text-pretty font-mono text-muted-foreground mt-2 text-xs">
            Developed eCommerce workflows and innovative self-payment, ticket printing systems for enhanced customer experience.
            </div>
          </div>
        </section>
        <section className="flex min-h-0 flex-col gap-y-3">
          ...
          <div className="rounded-lg bg-card text-card-foreground">
            ...
            <div className="text-pretty font-mono text-muted-foreground mt-2 text-xs">
            As a Frontend Development student with a focus on UI, I specialized in building responsive websites using HTML, CSS, and JavaScript, while also gaining skills in UI design principles and tools to create intuitive and visually appealing user interfaces.            </div>
          </div>
        </section>
        <section className="flex min-h-0 flex-col gap-y-3">
